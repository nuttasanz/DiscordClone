    ...
    <div class="max-w-[1260px] mx-auto px-10 relative text-white">
        <div class="h-[80px] flex justify-between items-center">
            ...
            <div class="flex text-[16px]">
                ...
                <a class="m-[10px] p-[10px]">Discover</a>
                <a class="m-[10px] p-[10px]">Safety</a>
                <a class="m-[10px] p-[10px]">Support</a>
                <a class="m-[10px] p-[10px]">Blog</a>
                <a class="m-[10px] p-[10px]">Careers</a>
            </div>
            <button class="bg-white text-black text-[14px] rounded-[40px] py-[7px] px-4">Open Discord</button>
        </div>
    </div>
</div>
</template>